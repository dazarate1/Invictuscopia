...
<div class="modal fade" id="edit{{ $cliente->id }}" tabindex="-1" role="dialog" aria-labelledby="editLabel{{ $cliente->id }}" aria-hidden="true">
...
<div class="modal fade" id="delete{{ $cliente->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteLabel{{ $cliente->id }}" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content clients-card">
      <div class="modal-header">
