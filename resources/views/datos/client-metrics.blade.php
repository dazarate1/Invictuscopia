      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            ...
            <input type="number" step="any" class="form-control" id="imc" name="imc" required />
          </div>
          <div class="mb-2">
            <label for="grasa_corporal" class="form-label">Grasa Corporal (%)</label>
            <input type="number" step="any" class="form-control" id="grasa_corporal" name="grasa_corporal" required />
          </div>
          <div class="mb-2">
            <label for="lvl_agua" class="form-label">Nivel de Agua (%)</label>
            <input type="number" step="any" class="form-control" id="lvl_agua" name="lvl_agua" required />
          </div>
          <div class="mb-2">
            <label for="grasa_visc" class="form-label">Grasa Visceral</label>
            <input type="number" step="any" class="form-control" id="grasa_visc" name="grasa_visc" required />
          </div>
          <div class="mb-2">
            <label for="musculo" class="form-label">Masa Muscular (Kg)</label>
            <input type="number" step="any" class="form-control" id="musculo" name="musculo" required />
          </div>
          <div class="mb-2">
          ...
          <div class="mb-2">
            ...
            <input type="number" step="any" class="form-control" id="metabolismo" name="metabolismo" required />
          </div>
          <div class="mb-2">
            <label for="masa_osea" class="form-label">Masa ósea (kg)</label>
            <input type="number" step="any" class="form-control" id="masa_osea" name="masa_osea" required />
          </div>
        </div>
